...
public:
	BDPTIntegrator(const Properties &props) : Integrator(props) {
        ...
        Log(EWarn, "!!!!!! Orbifold type is %s", m_otype.c_str());
        m_odata.setType(OrbifoldData::OrbifoldTypeFromString(m_otype));
	}
	...
	bool render(Scene *scene, RenderQueue *queue, const RenderJob *job,
        ...
        ref<OrbifoldData> odata(&m_odata);
